...
const runningText = {
	...
	extended: <p>In the past I hated running. Then COVID came and all of the climbing gyms were closed,
				so I was looking for some kind of alternative. My first runs were disaster (in my opinion) -
				I wasn’t able to run 4km without walking breaks. But it turned out I’m a totally persistent person.
				Soon I made my first 10km, which I thought to be a long distance. And then I went on a climbing trip to Austrian Alps,
				where I couldn’t climb because of a finger injury. So instead I continued running, this time in mountains.
				I used to think that long distance mountain running is an activity for sick masochists.
				Imagine my surprise, when I made first 17km with 750m elevation and felt great.
				Long distance mountain running turned out to be totally my activity.
